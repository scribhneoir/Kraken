                        ...
                        <form action="index.php" method="post">
                            <div id="pro_form" class="offset-2 col-md-8">
                                ...
                                <div class="form-group row">
                                    <label for="temp_password" class="offset-2 col-2 col-form-label font-weight-bold">Temporary Password</label>
                                    <div class="col-7">
                                        <input id="temp_password" name="temp_password" type="text" class="form-control"
                                            placeholder="" required="required">
                                    </div>
                                    <label for="new_password" class="offset-2 col-2 col-form-label font-weight-bold">New Password</label>
                                    <div class="col-7">
                                        <input id="new_password" name="new_password" type="password" class="form-control password"
                                               placeholder="" required="required">
                                    </div>
                                    <label for="new_password" class="offset-2 col-2 col-form-label font-weight-bold">Confirm Password</label>
                                    <div class="col-7">
